...
class dilepton_muons_bg_isocr_notautau_CorrJetIso15_dr_05_before_scan(dilepton_muons_bg_isocr_notautau_working_02_corrjetiso):
    bg_dir = "/afs/desy.de/user/n/nissanuv/nfs/x1x2x1/bg/skim/sum/type_sum"
    bg_retag = False
    #print dilepton_muons_bg_isocr_notautau_working_02_corrjetiso.weightString
    #print dilepton_muons_bg_isocr_notautau_working_02_corrjetiso.plot_kind
    #exit(0)
    #weightString = {
    #    'MET' : "Weight",
    #}

class dilepton_muons_bg_isocr_notautau_CorrJetIso15_dr_05_after_scan(dilepton_muons_bg_isocr_notautau_working_02_corrjetiso):
    bg_retag = False
    cuts = [
        {"name":"none", "title": "None", "condition" : "(MinDeltaPhiMetJets > 0.4 && BTagsDeepMedium == 0 && twoLeptonsCorrJetIso15Dr0.5 == 1 && MHT >= 220 &&  MET >= 200 && leptonFlavourCorrJetIso15Dr0.5 == \"Muons\" && invMassCorrJetIso15Dr0.5 < 12  && invMassCorrJetIso15Dr0.5 > 0.4 && !(invMassCorrJetIso15Dr0.5 > 3 && invMassCorrJetIso15Dr0.5 < 3.2) && !(invMassCorrJetIso15Dr0.5 > 0.75 && invMassCorrJetIso15Dr0.5 < 0.81) && vetoElectronsPassIso == 0 && vetoMuonsPassIso == 0)", "baseline" : "sameSignCorrJetIso15Dr0.5 == 0 && isoCrCorrJetIso15Dr0.5 == 0 && !tautauCorrJetIso15Dr0.5", "sc" : "sameSignCorrJetIso15Dr0.5 == 0 && isoCrCorrJetIso15Dr0.5 >= 1 && !tautauCorrJetIso15Dr0.5"},
    ]
    bg_dir = "/afs/desy.de/user/n/nissanuv/nfs/x1x2x1/bg/skim_scan/sum/type_sum"
    histograms_defs = [
        { "obs" : "invMassCorrJetIso15Dr0.5", "minX" : 0, "maxX" : 13, "bins" : 6, "blind" : [4,None]},# "customBins"  : [0,2,4,6,10,12] },
        { "obs" : "dilepBDTCorrJetIso15Dr0.5", "minX" : -1, "maxX" : 1, "bins" : 6, "blind" : [None,0.1]},# "customBins"  : [-1,-0.4,0,0.1,0.2,1] },
        #{ "obs" : "isoCrMinDr", "minX" : 0, "maxX" : 0.4, "bins" : 8},
        { "obs" : "deltaRCorrJetIso15Dr0.5", "minX" : 0, "maxX" : 3.5, "bins" : 8},
        { "obs" : "dilepHtCorrJetIso15Dr0.5", "minX" : 200, "maxX" : 800, "bins" : 8},
        { "obs" : "dileptonPtCorrJetIso15Dr0.5", "minX" : 0, "maxX" : 30, "bins" : 8},
        { "obs" : "MHT", "minX" : 220, "maxX" : 800, "bins" : 8},
        { "obs" : "MinDeltaPhiMhtJets", "minX" : 0, "maxX" : 3.5, "bins" : 8},
        { "obs" : "leptonsCorrJetIso15Dr0.5[0].Pt()", "minX" : 0, "maxX" : 20, "bins" : 8},
        { "obs" : "deltaPhiMetLepton1CorrJetIso15Dr0.5", "minX" : 0, "maxX" : 3.5, "bins" : 8},
        { "obs" : "mt1CorrJetIso15Dr0.5", "minX" : 0, "maxX" : 200, "bins" : 8},
        { "obs" : "leptonsCorrJetIso15Dr0.5[0].Eta()", "minX" : -2.4, "maxX" : 2.4, "bins" : 8},
        { "obs" : "NJets", "minX" : 0, "maxX" : 6, "bins" : 6},
        { "obs" : "deltaPhiMetLepton2CorrJetIso15Dr0.5", "minX" : 0, "maxX" : 3.5, "bins" : 8},
        { "obs" : "LeadingJetPt", "minX" : 0, "maxX" : 500, "bins" : 8},
        { "obs" : "LeadingJet.Eta()", "minX" : -2.4, "maxX" : 2.4, "bins" : 8},
        { "obs" : "deltaEtaCorrJetIso15Dr0.5", "minX" : 0, "maxX" : 5, "bins" : 8},
        { "obs" : "HT", "minX" : 0, "maxX" : 500, "bins" : 8},
        { "obs" : "leptonsCorrJetIso15Dr0.5[0].Phi()", "minX" : 0, "maxX" : 3.5, "bins" : 8},
    ]

class dilepton_muons_bg_isocr_notautau_CorrJetIso15_dr_05_after_scan_no_norm(dilepton_muons_bg_isocr_notautau_CorrJetIso15_dr_05_after_scan):
    normalise = False

class dilepton_muons_bg_isocr_notautau_CorrJetIso15_dr_05_after_scan_no_norm_ttjets(dilepton_muons_bg_isocr_notautau_CorrJetIso15_dr_05_after_scan_no_norm):
    choose_bg_files = True
    choose_bg_files_list = ["TTJets"]

class dilepton_muons_bg_isocr_notautau_CorrJetIso15_dr_05_before_scan_no_norm(dilepton_muons_bg_isocr_notautau_CorrJetIso15_dr_05_before_scan):
    normalise = False

class dilepton_muons_bg_isocr_notautau_CorrJetIso15_dr_05_before_scan_no_norm_ttjets(dilepton_muons_bg_isocr_notautau_CorrJetIso15_dr_05_before_scan_no_norm):
    choose_bg_files = True
    choose_bg_files_list = ["TTJets"]

class dilepton_muons_bg_isocr_notautau_CorrJetIso10_dr_05_before_scan(dilepton_muons_bg_isocr_notautau_CorrJetIso15_dr_05_before_scan):
    cuts = [
...
class dilepton_muons_bg_isocr_notautau_CorrJetIso10_dr_05_before_scan_no_norm(dilepton_muons_bg_isocr_notautau_CorrJetIso10_dr_05_before_scan):
    normalise = False
